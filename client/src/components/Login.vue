...
<template>
    <div class="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form @submit.prevent="authStore.login(form)" class="space-y-6">
                <div>
            ...
            <p class="mt-10 text-center text-sm text-gray-500">
                ¿No estas registrado?
                <RouterLink to="/register" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Registrarse
            </RouterLink>
        </p>
    </div>
</div></template>